...
sap.ui.define(["sap/ui/core/UIComponent",
	...
	function (UIComponent, ReuseComponentSupport) {
		...
		return UIComponent.extend("ui.s2p.mm.cntrl.ctrmass.update.ItemDistribution.Component", {
			metadata: {
				manifest: "json",
				library: "ui.s2p.mm.cntrl.ctrmass.update.ItemDistribution",
				properties: {
			...
			stStart: function (oModel, oBindingContext, oExtensionAPI) {
				if (this.getId() ===
					"ui.s2p.mm.cntrl.ctrmass.update::sap.suite.ui.generic.template.Canvas.view.Canvas::to_DetailItem--template::ImplementingComponentContent"
				) {
					...
					var oSTable = canvasview.byId("ItmDistTable");
