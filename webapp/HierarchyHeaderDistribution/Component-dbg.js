...
sap.ui.define(["sap/ui/core/UIComponent",
	...
	function (UIComponent, ReuseComponentSupport) {
		...
		return UIComponent.extend("ui.s2p.mm.cntrl.ctrmass.update.HierarchyHeaderDistribution.Component", {
			metadata: {
				manifest: "json",
				library: "ui.s2p.mm.cntrl.ctrmass.update.HierarchyHeaderDistribution",
				properties: {
			...
			stStart: function (oModel, oBindingContext, oExtensionAPI) {
				if (this.getId() ===
					"ui.s2p.mm.cntrl.ctrmass.update::sap.suite.ui.generic.template.Canvas.view.Canvas::to_HierHeadDistr--template::ImplementingComponentContent"
				) {
					var oComponentModel = this.getComponentModel();
					//            this._componetModel = this.getComponentModel();
					oExtensionAPI.attachPageDataLoaded(this.pageLoaded.bind(this,oExtensionAPI));
					//store oExtensionAPI navigationController
