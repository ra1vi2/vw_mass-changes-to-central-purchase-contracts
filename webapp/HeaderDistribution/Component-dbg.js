...
sap.ui.define(["sap/ui/core/UIComponent",
	...
	function (UIComponent, ReuseComponentSupport) {
		...
		return UIComponent.extend("ui.s2p.mm.cntrl.ctrmass.update.HeaderDistribution.Component", {
			metadata: {
				manifest: "json",
				library: "ui.s2p.mm.cntrl.ctrmass.update.HeaderDistribution",
				properties: {
			...
			stStart: function (oModel, oBindingContext, oExtensionAPI) {
				if (this.getId() ===
					"ui.s2p.mm.cntrl.ctrmass.update::sap.suite.ui.generic.template.Canvas.view.Canvas::to_Detail--template::ImplementingComponentContent"
				) {
					...
					var oSTable = canvasview.byId("HdrDistTable");
